...
class GoogleCalendarInitView(APIView):
    def get(self, request):
        ...
        flow = InstalledAppFlow.from_client_secrets_file(
            'client_secret.json', SCOPES, redirect_uri='http://localhost:8000/rest/v1/calendar/redirect/')
...
class GoogleCalendarRedirectView(APIView):
    def get(self, request):
        ...
        events_result = event.events().list(calendarId='primary', maxResults=15, singleEvents=True, orderBy='startTime').execute()
